...
# Import reusable helpers from the existing test script
from scripts.test_rag_queries import build_workflow, _force_mode_patch
...
def write_markdown_report(
    ...
    *,
    ...
    lines.extend(["", f"---", f"*Generated by eval_runner.py on {timestamp}*", ""])
